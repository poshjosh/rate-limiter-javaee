 ...
 * @see org.glassfish.jersey.uri.PatternWithGroups
 */
class PatternWithGroups {
    ...
    private static final PatternWithGroups.EmptyStringMatchResult EMPTY_STRING_MATCH_RESULT = new PatternWithGroups.EmptyStringMatchResult();
    ...
    public final MatchResult match(final CharSequence cs) {
        ...
        return (groupIndexes.length > 0) ? new PatternWithGroups.GroupIndexMatchResult(m) : m;
    }
